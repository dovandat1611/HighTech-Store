 ...
 * @author MinhLe
 */
public class CareerCustomerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAOCareer daoC = new DAOCareer();
        ArrayList<Career> list = daoC.getAllCareer();
        request.setAttribute("career", list);
        
        
        request.getRequestDispatcher("Client/career.jsp").forward(request, response);
    }
