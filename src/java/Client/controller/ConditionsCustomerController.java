 ...
 * @author MinhLe
 */
public class ConditionsCustomerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAOConditions daoC = new DAOConditions();
        ArrayList<Conditions> list = daoC.getAllConditions();
        request.setAttribute("conditions", list);

        request.getRequestDispatcher("Client/conditions.jsp").forward(request, response);
    }
