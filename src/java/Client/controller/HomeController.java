...
public class HomeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<News> listB1 = daoN.getBannerHeader();
        ArrayList<News> listB2 = daoN.getBannerMiddle1();
        ArrayList<News> listB3 = daoN.getBannerMiddle2();
        ArrayList<News> listB4 = daoN.getBannerLast();
        ArrayList<News> brandbanner = daoN.getAllBrandBanner();
        ArrayList<News> headertitle = daoN.getAllHeaderTitle();
        ...
        request.setAttribute("brandbanner", brandbanner);
        request.setAttribute("headertitle", headertitle);
        request.setAttribute("listB1", listB1);
        request.setAttribute("listB2", listB2);
        request.setAttribute("listB3", listB3);
        request.setAttribute("listB4", listB4);
