 ...
 * @author Lenovo
 */
public class NewsCustomerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<NewsView> list3 = daoN.pagingNewsView(pageNumber, pageSize);
        ...
        request.setAttribute("totalPages", daoN.getTotalPages(pageSize));
        request.getRequestDispatcher("Client/news.jsp").forward(request, response);
    }
