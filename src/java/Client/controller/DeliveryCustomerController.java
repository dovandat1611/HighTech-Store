 ...
 * @author MinhLe
 */
public class DeliveryCustomerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<Delivery> list = daoD.getAllDelivery();
        request.setAttribute("delivery", list);

        request.getRequestDispatcher("Client/delivery.jsp").forward(request, response);
    }
