 ...
 * @author MinhLe
 */
public class ReturnsCustomerController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        DAOReturns daoC = new DAOReturns();
        ArrayList<Returns> list = daoC.getAllReturns();
        request.setAttribute("returns", list);
        
        
        request.getRequestDispatcher("Client/returns.jsp").forward(request, response);
    }
