...
<%-- 
    Document   : addProduct
    Created on : May 16, 2023, 9:41:04 PM
    Author     : Lenovo
--%>
                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <c:forEach var="d" items="${data}">
                            <form class="forms-sample" method="post" action="ProductController">
                                            ...
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" name="product_name" id="product_name"  value="${d.product_name}" placeholder="Product Name" required>

                                                    </div>
                                                    <div class="form-group">
                                                        <label for="list_price">List Price</label>
                                                        <input type="text" class="form-control number" name="list_price" id="list_price" value="${d.list_price}" placeholder="Password" required>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="discount">Discount</label>
                                                        <input type="text" class="form-control" name="discount" id="discount" value="${d.discount}" placeholder="Discount" required>
                                                    </div>
                                                </div> 
                                            </div>
                                            <div class="col-md-6">
                                                <div class="card-body">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="category_id" id="category_id">
                                                            <c:forEach var="c" items="${listC}">
                                                                <option value="${c.category_id}" ${(d.category_id==c.category_id)? "selected" : ""}>${c.category_name}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="brand_id" id="brand_id">
                                                            <c:forEach var="b" items="${listB}">
                                                                <option value="${b.brand_id}" ${(d.brand_id == b.brand_id)? "selected" : ""}>${b.brand_name}</option>
                                                            </c:forEach>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="status" id="status" >   
                                                            <option value="Stocking" ${d.status.equalsIgnoreCase("Stocking")? "selected" : ""}>Stocking</option>
                                                            <option value="Sold out" ${d.status.equalsIgnoreCase("Sold out")? "selected" : ""}>Sold out</option> 
                                                        </select>
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea  name="sub_description" >${d.sub_description}</textarea>
                                                    </div>
                                                    <div class="form-group">
