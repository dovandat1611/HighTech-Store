            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        <form class="forms-sample" method="post" action="ContactInfoController">
                            <input type="hidden" name="service" value="updateContactInfo">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="title" id="title" value="${d.title}">
                                                </div>
                                                <div class="form-group">
