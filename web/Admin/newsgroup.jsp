...
<html lang="en">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            <h4 class="card-title card-title-dash">News Group</h4>
                                        </div>
                                        <div>
                                            <form class="search-form" action="NewsGroupController?service=searchNewsGroup" method="post">
                                                <input type="text" class="form-control" name="name" placeholder="Search Here" title="Search here">
                                            </form>
                                        </div>
                                        <div>
                                            <a href="NewsGroupController?service=insertNewsGroup" class="btn btn-primary text-white me-0"><i class="mdi mdi-account-plus"></i> Add new News Group</a>
                                        ...
                                        <table class="table table-hover" id="myTable">
                                            ...
                                            <tbody>
                                                <c:forEach items="${data}" var="d">
                                                    <tr>
                                                        <td>${d.newsgroup_id}</td>
                                                        <td>${d.newsgroup_name}</td>
                                                        <td><div class="badge badge-info"><a href="NewsGroupController?service=updateNewsGroup&id=${d.newsgroup_id}">Update</a></div></td>
                                                        <td ><div class="badge badge-danger"><a href="NewsGroupController?service=deleteNewsGroup&id=${d.newsgroup_id}">Delete</a></div></td> 
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table>
    ...
    <script>
                                                    function exportToExcel() {
                                                        ...
                                                        saveAsExcelFile(wbout, "newsgroup.xlsx");
                                                    }
