                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        ...
                        <form class="forms-sample" method="post" action="NewsController">
                            <input type="hidden" name="service" value="insertFooterTitle">
                                <div class="row">
                                    <div class="col-md-6 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Create Footer Title</h4>
                                                <p class="card-description">
                                                    Fill all the bank
                                                </p>
                                                <div class="form-group">
                                                    <label for="title">Footer Title</label>
                                                    <input type="text" class="form-control" name="title" id="title" placeholder="Footer Title">
                                                </div>
