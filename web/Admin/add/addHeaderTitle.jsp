                ...
                <div class="main-panel">     
                    <div class="content-wrapper">
                            <form class="forms-sample" method="post" action="NewsController">
                                <input type="hidden" name="service" value="insertHeaderTitle">
                                <div class="row">
                                    <div class="col-md-12 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Create Header Title</h4>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select class="form-control" name="content" id="content" >   
                                                        <option value="HomeController">HomeController</option>
                                                        <option value="ShopController">ShopController</option>
                                                        <option value="AboutCustomerController">AboutCustomerController</option>
                                                        <option value="ContactCustomerController">ContactCustomerController</option>
                                                        <option value="NewsCustomerController">NewsCustomerController</option> 
                                                        <option value="CartController">CartController</option> 
                                                    </select>
                                                </div>
