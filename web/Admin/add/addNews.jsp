                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        <form class="forms-sample" method="post" action="NewsController">
                            <input type="hidden" name="service" value="insertNews">
                            <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="newsgroup_id" id="newsgroup_id">
                                                    <c:forEach items="${listG}" var="g">
                                                        <option value="${g.newsgroup_id}">${g.newsgroup_name}</option>
                                                    </c:forEach>
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" onchange="previewImage()" accept="image/*" name="image" id="image" required>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea id="inputText" name="content"></textarea>
                                            </div>
