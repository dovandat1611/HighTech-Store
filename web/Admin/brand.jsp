                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        ...
                                        <div>
                                            <form class="search-form" action="BrandController?service=searchBrand" method="post">
                                                <input type="text" class="form-control" name="name" placeholder="Search Here" title="Search here">
                                            </form>
                                        </div>
                                        <div>
                                            <a href="BrandController?service=insertBrand" class="btn btn-primary text-white me-0"><i class="mdi mdi-account-plus"></i> Add new Brand</a>
                                            ...
                                            <tbody>
                                                <c:forEach items="${data}" var="d">
                                                    <tr>
                                                        <td>${d.brand_id}</td>
                                                        <td>${d.brand_name}</td>
                                                        <td><div class="badge badge-info"><a href="BrandController?service=updateBrand&id=${d.brand_id}">Update</a></div></td>
