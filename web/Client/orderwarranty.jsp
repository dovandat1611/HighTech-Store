                    ...
                    <tbody>
                        <c:forEach items="${data}" var="d">
                            <tr>
                                ...
                                <td style="width: 30%"><img src="${d.image}" alt="alt" style="width: 60%"/></td>
                                <td>${d.quantity_order}</td> 
                                <fmt:formatDate value="${d.order_date}" pattern="dd-MM-yyyy" var="formattedDate" />
                                <td>${formattedDate}</td> 
                                <td>
                                    <div>
                                        <a href="OrderWarrantyController?service=AddWarranty&id=${d.orderdetail_id}">Add Warranty</a>
                                    </div>
                                </td> 
                            </tr>
                        </c:forEach>
