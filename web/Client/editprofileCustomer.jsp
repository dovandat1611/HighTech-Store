                                    ...
                                    <div class="row gutters">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" value="${d.name}" id="fullName" placeholder="" required>
                                            </div>
                                        </div>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="dob" class="form-control" value="${d.dob}" id="dob" placeholder="" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row gutters">
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="address" value="${d.address}" class="form-control" id="Street" placeholder="" required>
                                            </div>
                                        </div><br>
                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
