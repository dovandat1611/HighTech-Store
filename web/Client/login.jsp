                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade active show" id="nav-sign-in" role="tabpanel" aria-labelledby="nav-sign-in-tab">
                                    ...
                                    <label>
                                        ...
                                        <span class="label-body"><a href="ForgotpasswordCustomerController" style="text-align: center">Forgot Password</a></span>
                                        <span class="label-body"> Or </span>
                                        <span class="label-body"><a href="RegisterController">Register</a></span>
                                    </label>
