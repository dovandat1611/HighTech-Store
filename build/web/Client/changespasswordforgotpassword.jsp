                            ...
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade active show" id="nav-sign-in" role="tabpanel" aria-labelledby="nav-sign-in-tab">
                                    <div class="form-group">
                                        ...
                                        <input type="password" minlength="2" name="password" placeholder="Create New Password" class="u-full-width bg-light" required="">
                                    </div>   
                                    <div class="form-group">
                                        <label for="sign-in">Re-Enter Password *</label>
                                        <input type="password" minlength="2" name="confirmPassword" placeholder="Re-Enter Password" class="u-full-width bg-light" required="">
                                    </div> 
