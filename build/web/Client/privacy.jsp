...
<html lang="en">
    ...
    <body>
        ...
        <section class="site-banner jarallax min-height300 padding-large" style="background: url() no-repeat;">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
        ...
        <section id="about-us">
            <div class="container ">
                <div class="row d-flex align-items-center">
                    <c:forEach items="${privacy}" var="p">
                        <div class="col-lg-12 col-md-12">
                            <div class="detail">
                                <div class="display-header">
                                    <h2 style="text-align: center" class="section-title">${p.getTitle()}</h2>
                                    <p>${p.getContent()}</p>
                                    <div class="btn-wrap">
                                        <a href="RegisterController" class="btn btn-dark btn-medium d-flex align-items-center" tabindex="0">Register<i class="icon icon-arrow-io"></i>
                                        </a>
                                    </div>
                                </div>
                            </div>
