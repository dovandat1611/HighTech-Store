                ...
                <div class="main-panel">
                    <div class="content-wrapper">
                        <c:forEach var="d" items="${data}">
                            <form class="forms-sample" method="post" action="WarrantyController">
                                <input type="hidden" name="service" value="updateWarrantyforAdmin">
                                <div class="row">
                                    <div class="col-md-12 grid-margin card">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="card-body">
                                                    <input type="hidden" name="id" value="${d.warranty_id}">
