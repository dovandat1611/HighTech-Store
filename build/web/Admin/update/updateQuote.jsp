            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        <form class="forms-sample" method="post" action="QuoteController">
                            <input type="hidden" name="service" value="updateQuote">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="author" id="author" value="${d.author}" placeholder="author">
                                                </div>
