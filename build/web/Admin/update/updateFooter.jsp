            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        ...
                        <form class="forms-sample" method="post" action="FooterContentController">
                            <input type="hidden" name="service" value="updateFooterContent">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="content" id="content" value="${d.content}" placeholder="content">
                                                </div>
