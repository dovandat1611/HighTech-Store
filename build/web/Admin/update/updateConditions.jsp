            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        <form class="forms-sample" method="post" action="ConditionsController">
                            <input type="hidden" name="service" value="updateConditions">
                            <c:forEach var="d" items="${data}">
                                <div class="row">                                 
                                    ...
                                    <div class="col-md-12 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Update Conditions</h4>
