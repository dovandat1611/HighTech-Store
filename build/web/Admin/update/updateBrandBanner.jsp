...
<%-- 
    Document   : addBrand
    Created on : May 16, 2023, 9:40:44 PM
    Author     : Lenovo
--%>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        ...
                        <form class="forms-sample" method="post" action="BrandBannerController">
                            <input type="hidden" name="service" value="updateBrandBanner">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <img id="preview-img" src="${d.image}" alt="Ảnh xem trước" style="width: 30%">
                                                    <input type="hidden" name="imageorig" value="${d.image}">
