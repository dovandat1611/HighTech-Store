            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        ...
                        <form class="forms-sample" method="post" action="BrandController">
                            <input type="hidden" name="service" value="updateBrand">
                                    ...
                                    <div class="col-md-6 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <input type="hidden" name="id" value="${d.brand_id}">
                                                <div class="form-group">
                                                    <label for="name">Brand Name</label>
                                                    <input type="text" class="form-control" name="name" value="${d.brand_name}" id="name" placeholder="Brand Name">
                                                </div>
