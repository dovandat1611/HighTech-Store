<%-- 
    Document   : updateUltras
    Created on : Jun 12, 2023, 8:57:46 PM
    Author     : MinhLe
--%>
<%@taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>
<%-- 
    Document   : addCategory
    Created on : May 16, 2023, 9:40:54 PM
    Author     : Lenovo
--%>
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        ...
                        <form class="forms-sample" method="post" action="FooterTitleController">
                            <input type="hidden" name="service" value="updateFooterTitle">
                            <c:forEach var="d" items="${data}">
                                <div class="row">
                                    <div class="col-md-6 grid-margin stretch-card">
                                        <div class="card">
                                            <div class="card-body">
                                                <h4 class="card-title">Update Footer Title</h4>
                                                <p class="card-description">
                                                    Fill all the bank
                                                </p>
                                                <input type="hidden" name="news_id" value="${d.news_id}">
                                                <input type="hidden" name="oldtitle" value="${d.title}">
                                                <div class="form-group">
                                                    <label for="title">Footer Title</label>
                                                    <input type="text" class="form-control" name="title" id="title" value="${d.title}" placeholder="Footer Title">
                                                </div>
