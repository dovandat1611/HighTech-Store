                ...
                <div class="main-panel">        
                    <div class="content-wrapper">
                        <form class="forms-sample" method="post" action="BannerController">
                            <input type="hidden" name="service" value="insertBanner">
                            <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="newsgroup_id">
                                                    <c:forEach var="d" items="${listG}">
                                                        <c:if test="${d.newsgroup_id == 9 or d.newsgroup_id == 18 or d.newsgroup_id == 19 or d.newsgroup_id == 20}">
                                                            <option value="${d.newsgroup_id}">${d.newsgroup_name}</option>
                                                        </c:if>
                                                    </c:forEach>
                                                </select>
                                            </div>
