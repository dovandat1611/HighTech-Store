...
<html lang="en">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="d-sm-flex justify-content-between align-items-start">
                                        <div>
                                            <h4 class="card-title card-title-dash">Comment</h4>
                                        </div>
                                        <div>
                                            <form class="search-form" action="CommentController?service=searchComment" method="post">
                                        ...
                                        <table class="table table-hover" id="myTable">
                                            ...
                                            <tbody>
                                                <c:forEach items="${data}" var="d">
                                                    <fmt:formatDate value="${d.comment_date}" pattern="dd-MM-yyyy" var="formattedDate" />
                                                    <tr>
                                                        <td>${d.comment_id}</td>
                                                        <td>${d.product_id}</td>
                                                        <td>${d.customer_id}</td>
                                                        ...
                                                        <td ><div class="badge badge-danger"><a href="CategoryController?service=deleteComment&id=${d.comment_id}">Delete</a></div></td> 
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
                                        </table> 
    ...
    <script>
                                                    function exportToExcel() {
                                                        ...
                                                        saveAsExcelFile(wbout, "comment.xlsx");
                                                    }
